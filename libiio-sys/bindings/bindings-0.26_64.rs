...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of iio_data_format"][::std::mem::size_of::<iio_data_format>() - 32usize];
    ["Alignment of iio_data_format"][::std::mem::align_of::<iio_data_format>() - 8usize];
    ["Offset of field: iio_data_format::length"]
        [::std::mem::offset_of!(iio_data_format, length) - 0usize];
    ["Offset of field: iio_data_format::bits"]
        [::std::mem::offset_of!(iio_data_format, bits) - 4usize];
    ["Offset of field: iio_data_format::shift"]
        [::std::mem::offset_of!(iio_data_format, shift) - 8usize];
    ["Offset of field: iio_data_format::is_signed"]
        [::std::mem::offset_of!(iio_data_format, is_signed) - 12usize];
    ["Offset of field: iio_data_format::is_fully_defined"]
        [::std::mem::offset_of!(iio_data_format, is_fully_defined) - 13usize];
    ["Offset of field: iio_data_format::is_be"]
        [::std::mem::offset_of!(iio_data_format, is_be) - 14usize];
    ["Offset of field: iio_data_format::with_scale"]
        [::std::mem::offset_of!(iio_data_format, with_scale) - 15usize];
    ["Offset of field: iio_data_format::scale"]
        [::std::mem::offset_of!(iio_data_format, scale) - 16usize];
    ["Offset of field: iio_data_format::repeat"]
        [::std::mem::offset_of!(iio_data_format, repeat) - 24usize];
};
unsafe extern "C" {
