...
include!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/bindings/bindings-0.25_64.rs"
));

#[cfg(all(unix, feature = "libiio_v0_25", target_pointer_width = "32"))]
include!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/bindings/bindings-0.25_32.rs"
));
